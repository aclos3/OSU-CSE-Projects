/***************************************************************************
**   Program Name: Final Project (Opal.cpp)
**   Author: Andrew Clos
**   Date: 8/12/2019
...
********************************************************************************/
std::vector<int> Opal::playerEnters(int shovels)
{
	...
	while (menuChoice != 3)
	{
		...
		if (menuChoice == 2)
		{
			...
			{  //the option to interact with the object in the room is presented.
				std::cout << "You also notice a simple wooden box with some shimmering letter of a foreign language written on it." << std::endl;
				std::cout << "(1) Attempt to Open the Box - this could be risky." << std::endl;
			...
			{   //if the object has been interacted with on an earlier call to look around, it cannot be interacted with again.
				std::cout << "...And the opened box." << std::endl;
			}
		}
