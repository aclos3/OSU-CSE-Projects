/***************************************************************************
**   Program Name: Final Project (Sapphire.cpp)
**   Author: Andrew Clos
**   Date: 8/12/2019
...
Sapphire::Sapphire()
{
	roomName = "\033[1;94mSapphire\033[0m";
	numDigSites = 32;
	costPerDig = 1;
	odds = 75;
	ptsPerGem = 18;
...
********************************************************************************/
std::vector<int> Sapphire::playerEnters(int shovels)
{
	...
	while (menuChoice != 3)
	{
		...
		if (menuChoice == 2)
		{
			...
			{  //the option to interact with the object in the room is presented.
				std::cout << "You also notice a musty trunk in the corner, it looks like you might be able to open it -- this could be risky." << std::endl;
				std::cout << "(1) Attempt to Open the Trunk." << std::endl;
				...
				{   //if user chooses to interact, there is an equal chance that something good, neutral or bad will happpen.
					...
					std::cout << "You pry at the lid..." << std::endl;
					//good fortune
					if (randomObject == 1)
					{
			...
			{   //if the object has been interacted with on an earlier call to look around, it cannot be interacted with again.
				std::cout << "...And the destroyed musty trunk." << std::endl;
			}
		}
...
void Sapphire::lookAround()
{
	...
	std::cout << "\033[1;94m                        .##%@@@@&@@&&&&&%@@@@@@@@@@@@@@&%%##(##@&&@@@@@@@@,                        \033[0m" << std::endl;
	std::cout << "\033[1;94m                            *@&@@&&&&&&&&@@@@@@@@@@@@@@@%%#####&@@&@@&*                            \033[0m" << std::endl;
	std::cout << "\033[1;94m                                 (&&@@@@@@@@@@@@@@@@@@@@@%%%%%#(@#                                 \033[0m" << std::endl << std::endl;
