/***************************************************************************
**   Program Name: Final Project (Ruby.cpp)
**   Author: Andrew Clos
**   Date: 8/12/2019
...
********************************************************************************/
std::vector<int> Ruby::playerEnters(int shovels)
{
	...
	while (menuChoice != 3)
	{
		...
		if (menuChoice == 2)
		{
			...
			{  //the option to interact with the object in the room is presented.
				std::cout << "You also notice a partially dug hole at the far end of the room." << std::endl;
				std::cout << "(1) Investigate the hole." << std::endl;
				...
				{   //if user chooses to interact, there is an equal chance that something good, neutral or bad will happpen.
					...
					std::cout << "You remove some loose earth from the hole..." << std::endl;
					//good fortune
					if (randomObject == 1)
					{
			...
			{   //if the object has been interacted with on an earlier call to look around, it cannot be interacted with again.
				std::cout << "...And the excavated hole." << std::endl;
			}
		}
...
void Ruby::lookAround()
{
	...
	std::cout << "\033[1;91m                                                    .(%%%%%%#////////%%%%*                         \033[0m" << std::endl;
	std::cout << "\033[1;91m                                                            ./%%%#////%%#                          \033[0m" << std::endl;
	std::cout << "\033[1;91m                                                                     ./(                           \033[0m" << std::endl << std::endl;
