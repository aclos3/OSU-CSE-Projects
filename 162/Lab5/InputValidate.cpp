/***************************************************************************
**   Program Name: Lab 5(InputValidate.cpp)
**   Author: Andrew Clos
**   Date: 
...
**				  for lab 5, the user entry methods have been changed to use  
**				  getline instead of cin >>. Also new for Lab5 is a function
**			      to validate space-delimited intgers held in a string object.
****************************************************************************/
